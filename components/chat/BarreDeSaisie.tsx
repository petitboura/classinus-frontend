  ...
  return (
    <div className="w-full">
      ...
      <div
        ...
        className="relative hidden rounded-cgpt-carte border border-dj-bordure bg-dj-surface px-4 py-3 focus-within:border-dj-bordure-forte md:@min-[360px]:block"
      >
        ...
        <div className="mt-2 flex flex-wrap items-center justify-between gap-y-2">
          <div className="flex items-center gap-3">
            ...
            {appliButtonVisible && selecteurNotionOuvert && (
              <div className="relative hidden md:@min-[360px]:block" ref={selecteurNotionRef}>
                <div className="absolute bottom-full left-0 z-30 mb-2 w-72 max-w-[calc(100vw-2rem)] rounded-xl border border-dj-bordure bg-dj-surface-haute p-1 shadow-xl">
                  {contenuSelecteurNotion("bg-dj-surface", "bg-dj-surface")}
                </div>
              </div>
      ...
      {texte.includes("$") && (
        <div
          ...
          className="mb-2 max-h-40 overflow-y-auto whitespace-pre-wrap break-words rounded-xl border border-dj-bordure bg-dj-surface px-3 py-2 text-[15px] leading-relaxed text-dj-texte md:hidden md:@max-[359px]:block"
        >
          {segmenterTexteAvecFormules(texte).map((s, i) =>
            s.formule ? (
              <span key={i} dangerouslySetInnerHTML={{ __html: rendreFormuleKatex(s.texte, !!s.bloc) }} />
      ...
      <div className="flex flex-col gap-1 rounded-cgpt-carte border border-dj-bordure bg-dj-surface px-3 py-2.5 focus-within:border-dj-bordure-forte md:hidden md:@max-[359px]:block">
        <textarea
