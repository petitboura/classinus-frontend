...
export function EspaceBibliotheque({
  ...
  // Chantier agent applicatif : le POC de câblage manuel (16/09/2026) a
  // été retiré (17/09/2026, voir plan-scan-generique-agent-applicatif.md)
  // -- le scan générique (lib/scanElementsInteractifs.ts) détecte
  // maintenant automatiquement ces boutons, sans déclaration à la main.
